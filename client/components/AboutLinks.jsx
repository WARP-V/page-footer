...
const AboutLinks = () => (
  <div id="hlinks" className="block internal closed">
    ...
    <ul>
      ...
      <li className="footer-link minor"><span>Careers</span></li>
      <li className="footer-link minor"><span>Converse Culture & Careers</span></li>
      <li className="footer-link minor"><span>Investors</span></li>
